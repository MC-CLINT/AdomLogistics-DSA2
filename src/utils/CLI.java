    ...
    while (inMenu) {
      ...
      switch (choice) {
        case "1":
          ...
          PackageDelivery newDelivery = new PackageDelivery(packageId, origin, destination, assignedVehicle,
              assignedDriver, eta);
        ...
        case "4":
          ...
          boolean deliveryUpdated = fileHandler.updateDeliveryInFile("../data/delivery.txt", pkgUpdate,
              updatedDelivery);
          if (deliveryUpdated)
      ...
      switch (choice) {
        ...
        case "4":
          try {
            ...
            System.out.print("Enter maximum fuel usage: ");
            double maxFuel = Double.parseDouble(scanner.nextLine().trim());
